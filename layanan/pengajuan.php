...
<body>
    ...
    <section class="pendaftaran" id="pendaftaran">
        ...
        <form action="prosesrfc.php" method="POST" enctype="multipart/form-data">
            ...
            <input type="date" id="tanggal" name="tanggal" required></textarea>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <textarea id="risk" name="risk" required></textarea>
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="file" id="file" name="file" accept=".pdf,.docx,.xlsx,.xls" required>
            </div>

            <button type="submit" class="btn" name="daftar" id="daftar">Ajukan</button>
            </form>
        </div>
    </section>
    <footer>
